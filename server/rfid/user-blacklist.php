...
//data kolom yang akan di tampilkan
    ...
    //nama table database
    $sTable = "(
        SELECT data_blacklist.id_blacklist as id_blacklist, data_blacklist.rf_id AS rf_id, rf_id_users.no_induk AS nid, rf_id_users.status AS status from data_blacklist LEFT JOIN rf_id_users ON data_blacklist.rf_id = rf_id_users.rf_id
      ) data_blacklist";
    $sOrder = '';
