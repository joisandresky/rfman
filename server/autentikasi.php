...
if(count($data) > 0){
    $query = "SELECT id_operator, username, nama_operator FROM tb_operators WHERE username = '$uname' AND password = '$pass'";
    ...
    if($rowCount > 0){
        ...
        echo json_encode(array('error' => 'InvalidCredentialsError'));
    }
}
?>
